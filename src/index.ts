...
import watchedMovieRoute from './routers/watchedMovie.route.js';
...
app.use([registerMovieRoute, updateMovieRoute, getMoviesRoute, deleteMovieRoute, watchedMovieRoute ]);
